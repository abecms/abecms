...
var route = function route(req, res, next) {
  ...
  _cli.log.write('create', 'selectTemplate: ' + req.query.selectTemplate);
  _cli.log.write('create', 'filePath: ' + req.query.filePath);
  _cli.log.write('create', 'tplName: ' + req.query.tplName);
