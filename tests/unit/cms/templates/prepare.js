...
describe('cmsTemplates.prepare', function() {
  before( function(done) {
    Manager.instance.init()
      .then(function () {
        this.fixture = {
          visibleTrue: fse.readFileSync(path.join(process.cwd(), 'tests', 'unit', 'fixtures', 'themes', 'default', 'templates', 'prepare-tag-visible-true.html'), 'utf-8'),
          visibleFalse: fse.readFileSync(path.join(process.cwd(), 'tests', 'unit', 'fixtures', 'themes', 'default', 'templates', 'prepare-tag-visible-false.html'), 'utf-8'),
          text: fse.readFileSync(path.join(process.cwd(), 'tests', 'unit', 'fixtures', 'themes', 'default', 'templates', 'prepare-tag-abe-text.html'), 'utf-8'),
          attribute: fse.readFileSync(path.join(process.cwd(), 'tests', 'unit', 'fixtures', 'themes', 'default', 'templates', 'prepare-tag-abe-attribute.html'), 'utf-8'),
          attributeConcat: fse.readFileSync(path.join(process.cwd(), 'tests', 'unit', 'fixtures', 'themes', 'default', 'templates', 'prepare-tag-abe-attribute-concat.html'), 'utf-8'),
          attributeMultiple: fse.readFileSync(path.join(process.cwd(), 'tests', 'unit', 'fixtures', 'themes', 'default', 'templates', 'prepare-tag-abe-attribute-multiple.html'), 'utf-8'),
          source: fse.readFileSync(path.join(process.cwd(), 'tests', 'unit', 'fixtures', 'themes', 'default', 'templates', 'prepare-tag-abe-source.html'), 'utf-8'),
          each: fse.readFileSync(path.join(process.cwd(), 'tests', 'unit', 'fixtures', 'themes', 'default', 'templates', 'prepare-tag-abe-each.html'), 'utf-8'),
          eachMultiple: fse.readFileSync(path.join(process.cwd(), 'tests', 'unit', 'fixtures', 'themes', 'default', 'templates', 'prepare-tag-abe-each-multiple.html'), 'utf-8'),
          eachMultiplePrepared: fse.readFileSync(path.join(process.cwd(), 'tests', 'unit', 'fixtures', 'themes', 'default', 'templates', 'prepare-tag-abe-each-multiple-prepared.html'), 'utf-8'),
          eachVariable: fse.readFileSync(path.join(process.cwd(), 'tests', 'unit', 'fixtures', 'themes', 'default', 'templates', 'prepare-tag-abe-each-variable.html'), 'utf-8'),
          rawHandlebar: fse.readFileSync(path.join(process.cwd(), 'tests', 'unit', 'fixtures', 'themes', 'default', 'templates', 'prepare-raw-handlebars.html'), 'utf-8'),
          noHtml: fse.readFileSync(path.join(process.cwd(), 'tests', 'unit', 'fixtures', 'themes', 'default', 'templates', 'prepare-tag-nohtml.html'), 'utf-8')
        }
        done()
  ...
  it('cmsTemplates.prepare.addAbeSourceComment() each', function() {
    var template = cmsTemplates.prepare.addAbeSourceComment(this.fixture.each, {
        abe_source: {
          test: [{title: "test"}]
        }
      })
  ...
  it('cmsTemplates.prepare.addAbeSourceComment() eachMultiple', function() {
    var template = cmsTemplates.prepare.addAbeSourceComment(this.fixture.eachMultiple, {
        abe_source: {
          test: [{title: "test"}]
        }
      })
  ...
  it('cmsTemplates.prepare.addAbeSourceComment() eachVariable', function() {
    var template = cmsTemplates.prepare.addAbeSourceComment(this.fixture.eachVariable, {
        abe_source: {
          test: [{title: "test"}]
        }
      })
