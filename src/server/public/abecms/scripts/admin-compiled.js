...
},{"hepburn":2,"pinyin":4,"speakingurl":8}],2:[function(require,module,exports){
/*jslint node: true */
'use strict';
...
},{"./src/pinyin":7}],5:[function(require,module,exports){
module.exports = {
"èr":"二贰",
"shí":"十时实蚀",
"yǐ":"乙已以蚁倚",
...
},{"./dict-zi-web":5,"./phonetic-symbol.js":6,"_process":16}],8:[function(require,module,exports){
module.exports = require('./lib/speakingurl');

},{"./lib/speakingurl":9}],9:[function(require,module,exports){
          ...
          if (linkedTpl == null || linkedTpl == this._selectedTemplate) {
            ...
            if (id != null) {
              ...
              if (input.nodeName === 'SELECT' && maxlength != '1') {
                ...
                (0, _jsonObject.setObjByString)(values, id, mergedValues);
...
},{"../utils/jsonObject":21,"./FolderSelect":18,"limax":1,"nanoajax":10,"qs":12}],20:[function(require,module,exports){
'use strict';
