...
(function (h) {
  ...
  function Y(a) {
    ...
    if (!_m.__browser) {
      var b = {};_m.__browser = b;var c = h('<div/>').css({ position: 'fixed', top: 0, left: 0, height: 1, width: 1, overflow: 'hidden' }).append(h('<div/>').css({ position: 'absolute', top: 1, left: 1,
    ...
    }h.extend(a.oBrowser, _m.__browser);a.oScroll.iBarWidth = _m.__browser.barWidth;
    ...
    var c = _m.defaults.column,
        d = a.aoColumns.length,
        c = h.extend({}, _m.models.oColumn, c, { nTh: b ? b : I.createElement('th'), sTitle: c.sTitle ? c.sTitle : b ? b.innerHTML : '', aDataSort: c.aDataSort ? c.aDataSort : [d], mData: c.mData ? c.mData : d, idx: d });a.aoColumns.push(c);c = a.aoPreSearchCols;c[d] = h.extend({}, _m.models.oSearch, c[d]);ja(a, d, h(b).data());
  }function ja(a, b, c) {
    var b = a.aoColumns[b],
        d = a.oClasses,
        e = h(b.nTh);if (!b.sWidthOrig) {
      b.sWidthOrig = e.attr('width') || null;var f = (e.attr('style') || '').match(/width:\s*(\d+[pxem%]+)/);f && (b.sWidthOrig = f[1]);
    }c !== k && null !== c && (fb(c), K(_m.defaults.column, c), c.mDataProp !== k && !c.mData && (c.mData = c.mDataProp), c.sType && (b._sManualType = c.sType), c.className && !c.sClass && (c.sClass = c.className), h.extend(b, c), E(b, c, 'sWidth', 'sWidthOrig'), c.iDataSort !== k && (b.aDataSort = [c.iDataSort]), E(b, c, 'aDataSort'));var g = b.mData,
        j = Q(g),
  ...
  function N(a, b, c, d) {
    var e = a.aoData.length,
        f = h.extend(!0, {}, _m.models.oRow, { src: c ? 'dom' : 'data', idx: e });f._aData = b;a.aoData.push(f);for (var g = a.aoColumns, j = 0, i = g.length; j < i; j++) {
      g[j].sType = null;
      ...
      var c = function c(a, b, f) {
        var g, j;if ('' !== f) {
          j = La(f);for (var i = 0, n = j.length; i < n; i++) {
            f = j[i].match(ba);g = j[i].match(V);if (f) {
    ...
    if (h.isPlainObject(a)) return R(a._);if (null === a) return function () {};if ('function' === typeof a) return function (b, d, e) {
      ...
      var b = function b(a, d, e) {
        var e = La(e),
          ...
          g = e[i].match(ba);j = e[i].match(V);if (g) {
  ...
  function Ja(a, b, c, d) {
    ...
    var b = u(a, 'aoPreDrawCallback', 'preDraw', [a]);if (-1 !== h.inArray(!1, b)) C(a, !1);else {
      ...
      } else c = f.sZeroRecords, 1 == a.iDraw && 'ajax' == y(a) ? c = f.sLoadingRecords : f.sEmptyTable && 0 === a.fnRecordsTotal() && (c = f.sEmptyTable), b[0] = h('<tr/>', { 'class': e ? d[0] : '' }).append(h('<td />', { valign: 'top', colSpan: aa(a), 'class': a.oClasses.sRowEmpty }).html(c))[0];u(a, 'aoHeaderCallback', 'header', [h(a.nTHead).children('tr')[0], Ma(a), g, n, i]);u(a, 'aoFooterCallback', 'footer', [h(a.nTFoot).children('tr')[0], Ma(a), g, n, i]);d = h(a.nTBody);d.children().detach();d.append(h(b));u(a, 'aoDrawCallback', 'draw', [a]);a.bSorted = !1;a.bFiltered = !1;a.bDrawing = !1;
    }
  }function T(a, b) {
    var c = a.oFeatures,
        d = c.bFilter;
    ...
    var b = a.oClasses,
      ...
      } else if ('>' == j) e = e.parent();else if ('l' == j && d.bPaginate && d.bLengthChange) g = ob(a);else if ('f' == j && d.bFilter) g = pb(a);else if ('r' == j && d.bProcessing) g = qb(a);else if ('t' == j) g = rb(a);else if ('i' == j && d.bInfo) g = sb(a);else if ('p' == j && d.bPaginate) g = tb(a);else if (0 !== _m.ext.feature.length) {
        i = _m.ext.feature;q = 0;for (n = i.length; q < n; q++) {
          if (j == i[q].cFeature) {
    ...
    var b = a.aoColumns,
        ...
        n,
        l,
        q = W(a);g = a._iDisplayStart;i = !1 !== d.bPaginate ? a._iDisplayLength : -1;var k = function k(a, b) {
      j.push({ name: a, value: b });
    };k('sEcho', a.iDraw);k('iColumns', c);k('sColumns', F(b, 'sName').join(','));k('iDisplayStart', g);k('iDisplayLength', i);var S = { draw: a.iDraw, columns: [], order: [], start: g, length: i, search: { value: e.sSearch, regex: e.bRegex } };for (g = 0; g < c; g++) {
    ...
    }), k('iSortingCols', q.length));b = _m.ext.legacy.ajax;return null === b ? a.sAjaxSource ? j : S : b ? j : S;
  }function vb(a, b) {
    var c = sa(a, b),
    ...
    for (var b = _m.ext.search, c = a.aiDisplay, d, e, f = 0, g = b.length; f < g; f++) {
      for (var j = [], i = 0, n = c.length; i < n; i++) {
        e = c[i], d = a.aoData[e], b[f](a, d._aFilterData, e, d._aData, i) && j.push(e);
      }c.length = 0;h.merge(c, j);
    }
  }function xb(a, b, c, d, e, f) {
    if ('' !== b) for (var g = a.aiDisplay, d = Qa(b, d, e, f), e = g.length - 1; 0 <= e; e--) {
    ...
    var d = Qa(b, d, e, f),
        ...
        f = a.aiDisplayMaster,
        g;0 !== _m.ext.search.length && (c = !0);g = zb(a);if (0 >= b.length) a.aiDisplay = f.slice();else {
    ...
    var b = a.aoColumns,
        ...
        i,
        h,
        l = _m.ext.type.search;c = !1;d = 0;for (f = a.aoData.length; d < f; d++) {
    ...
    var b,
      ...
      nb(a);kb(a);ea(a, a.aoHeader);ea(a, a.aoFooter);C(a, !0);c.bAutoWidth && Ha(a);b = 0;for (c = e.length; b < c; b++) {
    ...
    a._bInitComplete = !0;(b || a.oInit.aaData) && U(a);u(a, null, 'plugin-init', [a, b]);u(a, 'aoInitComplete', 'init', [a, b]);
  }function Ra(a, b) {
    ...
    var b = h(a.nTable);b.attr('role', 'grid');var c = a.oScroll;if ('' === c.sX && '' === c.sY) return a.nTable;var d = c.sX,
        ...
        i = h(b[0].cloneNode(!1)),
        n = h(b[0].cloneNode(!1)),
        l = b.children('tfoot');l.length || (l = null);i = h('<div/>', { 'class': f.sScrollWrapper }).append(h('<div/>', { 'class': f.sScrollHead }).css({ overflow: 'hidden', position: 'relative', border: 0, width: d ? !d ? null : x(d) : '100%' }).append(h('<div/>', { 'class': f.sScrollHeadInner }).css({ 'box-sizing': 'content-box', width: c.sXInner || '100%' }).append(i.removeAttr('id').css('margin-left', 0).append('top' === j ? g : null).append(b.children('thead'))))).append(h('<div/>', { 'class': f.sScrollBody }).css({ position: 'relative', overflow: 'auto', width: !d ? null : x(d) }).append(b));l && i.append(h('<div/>', { 'class': f.sScrollFoot }).css({ overflow: 'hidden', border: 0, width: d ? !d ? null : x(d) : '100%' }).append(h('<div/>', { 'class': f.sScrollFootInner }).append(n.removeAttr('id').css('margin-left', 0).append('bottom' === j ? g : null).append(b.children('tfoot')))));var b = i.children(),
        k = b[0],
        f = b[1],
    ...
    };v = j.scrollHeight > j.clientHeight;if (a.scrollBarVis !== v && a.scrollBarVis !== k) a.scrollBarVis = v, U(a);else {
      a.scrollBarVis = v;G.children('thead, tfoot').remove();
      u && (w = u.clone().prependTo(G), P = u.find('tr'), w = w.find('tr'));y = o.clone().prependTo(G);o = o.find('tr');v = y.find('tr');y.find('th, td').removeAttr('tabindex');c || (q.width = '100%', f[0].style.width = '100%');h.each(qa(a, y), function (b, c) {
        D = Z(a, b);c.style.width = a.aoColumns[D].sWidth;
      });u && J(function (a) {
        a.style.width = '';
      }, w);f = G.outerWidth();if ('' === c) {
        r.width = '100%';if (Ua && (G.find('tbody').height() > j.offsetHeight || 'scroll' == l.css('overflow-y'))) r.width = x(G.outerWidth() - b);f = G.outerWidth();
      } else '' !== d && (r.width = x(d), f = G.outerWidth());J(E, v);J(function (a) {
    ...
    var b,
      ...
      i = n[a][0];f = e[i].aDataSort;b = 0;for (c = f.length; b < c; b++) {
        g = f[b], j = e[g].sType || 'string', n[a]._idx === k && (n[a]._idx = h.inArray(n[a][1], e[g].asSorting)), d.push({ src: i, col: g, dir: n[a][1], index: n[a]._idx, type: j, formatter: _m.ext.type.order[j + '-pre'] });
      }
    }return d;
  }function mb(a) {
    var b,
    ...
    };'number' === typeof e[0] && (e = a.aaSorting = [e]);c && a.oFeatures.bSortMulti ? (c = h.inArray(b, F(e, '0')), -1 !== c ? (b = g(e[c], !0), null === b && 1 === e.length && (b = 0), null === b ? e.splice(c, 1) : (e[c][1] = f[b], e[c]._idx = b)) : (e.push([b, f[0], 0]), e[e.length - 1]._idx = 0)) : e.length && e[0][0] == b ? (b = g(e[0]), e.length = 1, e[0][1] = f[b], e[0]._idx = b) : (e.length = 0, e.push([b, f[0]]), e[0]._idx = 0);T(a);'function' == typeof d && d(a);
  }function Oa(a, b, c, d) {
    ...
    var c = a.aoColumns[b],
        d = _m.ext.order[c.sSortDataType],
        e;d && (e = d.call(a.oInstance, a, b, $(a, b)));for (var f, g = _m.ext.type.order[c.sType + '-pre'], j = 0, i = a.aoData.length; j < i; j++) {
    ...
    var b,
      ...
      var e = a.fnStateLoadCallback.call(a.oInstance, a);if (e && e.time && (b = u(a, 'aoStateLoadParams', 'stateLoadParams', [a, e]), -1 === h.inArray(!1, b) && (b = a.iStateDuration, !(0 < b && e.time < +new Date() - 1E3 * b) && d.length === e.columns.length))) {
        ...
        e.start !== k && (a._iDisplayStart = e.start, a.iInitDisplayStart = e.start);e.length !== k && (a._iDisplayLength = e.length);e.order !== k && (a.aaSorting = [], h.each(e.order, function (b, c) {
    ...
    var b = _m.settings,
        a = h.inArray(a, F(b, 'nTable'));return -1 !== a ? b[a] : null;
  }function L(a, b, c, d) {
    c = 'DataTables warning: ' + (a ? 'table id=' + a.sTableId + ' - ' : '') + c;d && (c += '. For more information about this error, please see http://datatables.net/tn/' + d);if (b) D.console && console.log && console.log(c);else if (b = _m.ext, b = b.sErrMode || b.errMode, a && u(a, null, 'error', [a, d, c]), 'alert' == b) alert(c);else {
  ...
  function u(a, b, c, d) {
    ...
    var c = a.renderer,
        d = _m.ext.renderer[b];return h.isPlainObject(c) && c[b] ? d[c[b]] || d._ : 'string' === typeof c ? d[c] || d._ : d._;
  }function y(a) {
    ...
    return function () {
      var b = [za(this[_m.ext.iApiIndex])].concat(Array.prototype.slice.call(arguments));return _m.ext.internal[a].apply(this, b);
    };
  }var _m,
      v,
      _r,
    ...
    a[b] !== k && (a[c] = a[b]);
      ...
      wa = h('<div>')[0],
      $b = wa.textContent !== k,
      ac = /<.*?>/g;_m = function m(a) {
    this.$ = function (a, b) {
      return this.api(!0).$(a, b);
    };this._ = function (a, b) {
      return this.api(!0).rows(a, b).data();
    };this.api = function (a) {
      return a ? new _r(za(this[v.iApiIndex])) : new _r(this);
    ...
    this.fnSettings = function () {
      ...
      var h = this.api(!0);c === k || null === c ? h.row(b).data(a) : h.cell(b, c).data(a);(e === k || e) && h.columns.adjust();(d === k || d) && h.draw();return 0;
        ...
        c = a === k,
        d = this.length;c && (a = {});this.oApi = this.internal = v.internal;for (var e in _m.ext.internal) {
      e && (this[e] = Nb(e));
    }this.each(function () {
      var e = {},
          e = 1 < d ? Lb(e, a, !0) : a,
        ...
        eb(l);fb(l.column);K(l, l, !0);K(l.column, l.column, !0);K(l, h.extend(e, q.data()));var t = _m.settings,
          ...
          var p = t[g];if (p.nTable == this || p.nTHead.parentNode == this || p.nTFoot && p.nTFoot.parentNode == this) {
            ...
            if (e.bDestroy !== k ? e.bDestroy : l.bDestroy) {
              ...
              L(p, 0, 'Cannot reinitialise DataTable', 3);return;
            }
          }if (p.sTableId == this.id) {
            t.splice(g, 1);break;
          }
        }if (null === i || '' === i) this.id = i = 'DataTables_Table_' + _m.ext._unique++;var o = h.extend(!0, {}, _m.models.oSettings, { sDestroyWidth: q[0].style.width, sInstance: i, sTableId: i });o.nTable = this;o.oApi = b.internal;o.oInit = e;t.push(o);o.oInstance = 1 === b.length ? b : q.dataTable();eb(e);e.oLanguage && Fa(e.oLanguage);e.aLengthMenu && !e.iDisplayLength && (e.iDisplayLength = h.isArray(e.aLengthMenu[0]) ? e.aLengthMenu[0][0] : e.aLengthMenu[0]);e = Lb(h.extend(!0, {}, l), e);E(o.oFeatures, e, 'bPaginate bLengthChange bFilter bSort bSortMulti bInfo bProcessing bAutoWidth bSortClasses bServerSide bDeferRender'.split(' '));E(o, e, ['asStripeClasses', 'ajax', 'fnServerData', 'fnFormatNumber', 'sServerMethod', 'aaSorting', 'aaSortingFixed', 'aLengthMenu', 'sPaginationType', 'sAjaxSource', 'sAjaxDataProp', 'iStateDuration', 'sDom', 'bSortCellsTop', 'iTabIndex', 'fnStateLoadCallback', 'fnStateSaveCallback', 'renderer', 'searchDelay', 'rowId', ['iCookieDuration', 'iStateDuration'], ['oSearch', 'oPreviousSearch'], ['aoSearchCols', 'aoPreSearchCols'], ['iDisplayLength', '_iDisplayLength'], ['bJQueryUI', 'bJUI']]);E(o.oScroll, e, [['sScrollX', 'sX'], ['sScrollXInner', 'sXInner'], ['sScrollY', 'sY'], ['bScrollCollapse', 'bCollapse']]);E(o.oLanguage, e, 'fnInfoCallback');z(o, 'aoDrawCallback', e.fnDrawCallback, 'user');z(o, 'aoServerParams', e.fnServerParams, 'user');z(o, 'aoStateSaveParams', e.fnStateSaveParams, 'user');z(o, 'aoStateLoadParams', e.fnStateLoadParams, 'user');z(o, 'aoStateLoaded', e.fnStateLoaded, 'user');z(o, 'aoRowCallback', e.fnRowCallback, 'user');z(o, 'aoRowCreatedCallback', e.fnCreatedRow, 'user');z(o, 'aoHeaderCallback', e.fnHeaderCallback, 'user');z(o, 'aoFooterCallback', e.fnFooterCallback, 'user');z(o, 'aoInitComplete', e.fnInitComplete, 'user');z(o, 'aoPreDrawCallback', e.fnPreDrawCallback, 'user');o.rowIdFn = Q(e.rowId);gb(o);i = o.oClasses;e.bJQueryUI ? (h.extend(i, _m.ext.oJUIClasses, e.oClasses), e.sDom === l.sDom && 'lfrtip' === l.sDom && (o.sDom = '<"H"lfr>t<"F"ip>'), o.renderer) ? h.isPlainObject(o.renderer) && !o.renderer.header && (o.renderer.header = 'jqueryui') : o.renderer = 'jqueryui' : h.extend(i, _m.ext.classes, e.oClasses);q.addClass(i.sTable);o.iInitDisplayStart === k && (o.iInitDisplayStart = e.iDisplayStart, o._iDisplayStart = e.iDisplayStart);null !== e.iDeferLoading && (o.bDeferLoading = !0, g = h.isArray(e.iDeferLoading), o._iRecordsDisplay = g ? e.iDeferLoading[0] : e.iDeferLoading, o._iRecordsTotal = g ? e.iDeferLoading[1] : e.iDeferLoading);var r = o.oLanguage;h.extend(!0, r, e.oLanguage);'' !== r.sUrl && (h.ajax({ dataType: 'json', url: r.sUrl, success: function success(a) {
            Fa(a);K(l.oLanguage, a);h.extend(true, r, a);ga(o);
        ...
        }var w = o.oFeatures;e.bStateSave && (w.bStateSave = !0, Kb(o, e), z(o, 'aoDrawCallback', ya, 'state_save'));if (e.aaSorting === k) {
          t = o.aaSorting;g = 0;for (j = t.length; g < j; g++) {
            t[g][1] = o.aoColumns[g].asSorting[0];
          }
        }xa(o);w.bSort && z(o, 'aoDrawCallback', function () {
          if (o.bSorted) {
            var a = W(o),
  ...
  };_m.Api = _r;h.extend(_r.prototype, { any: function any() {
      return 0 !== this.count();
    }, concat: w.concat,
    ...
    indexOf: w.indexOf || function (a, b) {
      ...
      var e = [],
        ...
        var o = new _r(l[g]);if ('table' === b) f = c.call(o, l[g], g), f !== k && e.push(f);else if ('columns' === b || 'rows' === b) f = c.call(o, l[g], this[g], g), f !== k && e.push(f);else if ('column' === b || 'column-rows' === b || 'row' === b || 'cell' === b) {
          t = this[g];'column-rows' === b && (m = Da(l[g], p.opts));i = 0;for (n = t.length; i < n; i++) {
    ...
    var c = a.context;if (c.length && a.length) {
      var d = c[0].aoData[a[0]];if (d._details) {
        (d._detailsShow = b) ? d._details.insertAfter(d.nTr) : d._details.detach();var e = c[0],
            f = new _r(e),
            g = e.aoData;f.off('draw.dt.DT_details column-visibility.dt.DT_details destroy.dt.DT_details');0 < F(g, '_details').length && (f.on('draw.dt.DT_details', function (a, b) {
    ...
    a === k ? a = '' : h.isPlainObject(a) && (b = a, a = '');var b = ab(b),
      ...
      var e = a,
          ...
          g = c.aoColumns,
          j = F(g, 'sName'),
          i = F(g, 'nTh');return $a('column', e, function (a) {
    ...
    return this.iterator('column', function (c, d) {
      if (a === k) return c.aoColumns[d].bVisible;var e = c.aoColumns,
          ...
          j,
          i,
          n;if (a !== k && f.bVisible !== a) {
        if (a) {
          var l = h.inArray(!0, F(e, 'bVisible'), d + 1);j = 0;for (i = g.length; j < i; j++) {
  ...
  });_m.versionCheck = _m.fnVersionCheck = function (a) {
    for (var b = _m.version.split('.'), a = a.split('.'), c, d, e = 0, f = a.length; e < f; e++) {
      if (c = parseInt(b[e], 10) || 0, d = parseInt(a[e], 10) || 0, c !== d) return c > d;
    }return !0;
  };_m.isDataTable = _m.fnIsDataTable = function (a) {
    var b = h(a).get(0),
        c = !1;h.each(_m.settings, function (a, e) {
      var f = e.nScrollHead ? h('table', e.nScrollHead)[0] : null,
          g = e.nScrollFoot ? h('table', e.nScrollFoot)[0] : null;if (e.nTable === b || f === b || g === b) c = !0;
    });return c;
  };_m.tables = _m.fnTables = function (a) {
    var b = !1;h.isPlainObject(a) && (b = a.api, a = a.visible);var c = h.map(_m.settings, function (b) {
      if (!a || a && h(b.nTable).is(':visible')) return b.nTable;
    });return b ? new _r(c) : c;
  };_m.util = { throttle: ua, escapeRegex: va };_m.camelToHungarian = K;p('$()', function (a, b) {
    ...
    a = a || !1;return this.iterator('table', function (b) {
      ...
      }));c = h.inArray(b, _m.settings);-1 !== c && _m.settings.splice(c, 1);
    });
    ...
    _aData: [], _aSortData: null, _aFilterData: null, _sFilterRow: null, _sRowStripe: '', src: null, idx: -1 };_m.models.oColumn = { idx: null, aDataSort: null, asSorting: null, bSearchable: null, bSortable: null, bVisible: null, _sManualType: null, _bAttrSrc: !1, fnCreatedCell: null, fnGetData: null, fnSetData: null, mData: null, mRender: null, nTh: null, nTf: null, sClass: null, sContentPadding: null, sDefaultContent: null, sName: null, sSortDataType: 'std', sSortingClass: null, sSortingClassJUI: null, sTitle: null, sType: null, sWidth: null, sWidthOrig: null };_m.defaults = { aaData: null, aaSorting: [[0, 'asc']], aaSortingFixed: [], ajax: null, aLengthMenu: [10, 25, 50, 100], aoColumns: null, aoColumnDefs: null, aoSearchCols: [], asStripeClasses: null, bAutoWidth: !0, bDeferRender: !1, bDestroy: !1, bFilter: !0, bInfo: !0, bJQueryUI: !1, bLengthChange: !0, bPaginate: !0, bProcessing: !1, bRetrieve: !1, bScrollCollapse: !1, bServerSide: !1, bSort: !0, bSortMulti: !0, bSortCellsTop: !1, bSortClasses: !0, bStateSave: !1, fnCreatedRow: null, fnDrawCallback: null, fnFooterCallback: null, fnFormatNumber: function fnFormatNumber(a) {
      ...
      sInfoFiltered: '(filtered from _MAX_ total entries)', sInfoPostFix: '', sDecimal: '', sThousands: ',', sLengthMenu: 'Show _MENU_ entries', sLoadingRecords: 'Loading...', sProcessing: 'Processing...', sSearch: 'Search:', sSearchPlaceholder: '', sUrl: '', sZeroRecords: 'No matching records found' }, oSearch: h.extend({}, _m.models.oSearch), sAjaxDataProp: 'data', sAjaxSource: null, sDom: 'lfrtip', searchDelay: null, sPaginationType: 'simple_numbers', sScrollX: '', sScrollXInner: '', sScrollY: '', sServerMethod: 'GET', renderer: null, rowId: 'DT_RowId' };
  Y(_m.defaults);_m.defaults.column = { aDataSort: null, iDataSort: -1, asSorting: ['asc', 'desc'], bSearchable: !0, bSortable: !0, bVisible: !0, fnCreatedCell: null, mData: null, mRender: null, sCellType: 'td', sClass: '', sContentPadding: '', sDefaultContent: null, sName: '', sSortDataType: 'std', sTitle: null, sType: null, sWidth: null };Y(_m.defaults.column);_m.models.oSettings = { oFeatures: { bAutoWidth: null, bDeferRender: null, bFilter: null, bInfo: null, bLengthChange: null, bPaginate: null, bProcessing: null, bServerSide: null, bSort: null, bSortMulti: null,
    ...
    }, oInstance: null, sInstance: null, iTabIndex: 0, nScrollHead: null, nScrollFoot: null, aLastSort: [], oPlugins: {}, rowIdFn: null, rowId: null };_m.ext = v = { buttons: {}, classes: {}, builder: '-source-', errMode: 'alert', feature: [], search: [], selector: { cell: [], column: [], row: [] }, internal: {}, legacy: { ajax: null }, pager: {}, renderer: { pageButton: {},
      header: {} }, order: {}, type: { detect: [], search: {}, order: {} }, _unique: 0, fnVersionCheck: _m.fnVersionCheck, iApiIndex: 0, oJUIClasses: {}, sVersion: _m.version };h.extend(v, { afnFiltering: v.search, aTypes: v.type.detect, ofnSearch: v.type.search, oSort: v.type.order, afnSortData: v.order, aoFeatures: v.feature, oApi: v.internal, oStdClasses: v.classes, oPagination: v.pager });h.extend(_m.ext.classes, { sTable: 'dataTable', sNoFooter: 'no-footer', sPageButton: 'paginate_button', sPageButtonActive: 'current', sPageButtonDisabled: 'disabled', sStripeOdd: 'odd',
    ...
    sScrollHeadInner: 'dataTables_scrollHeadInner', sScrollBody: 'dataTables_scrollBody', sScrollFoot: 'dataTables_scrollFoot', sScrollFootInner: 'dataTables_scrollFootInner', sHeaderTH: '', sFooterTH: '', sSortJUIAsc: '', sSortJUIDesc: '', sSortJUI: '', sSortJUIAscAllowed: '', sSortJUIDescAllowed: '', sSortJUIWrapper: '', sSortIcon: '', sJUIHeader: '', sJUIFooter: '' });var Ea = '',
      ...
      Xb = Ea + 'fg-toolbar ui-toolbar ui-widget-header ui-helper-clearfix';h.extend(_m.ext.oJUIClasses, _m.ext.classes, { sPageButton: 'fg-button ui-button ' + H, sPageButtonActive: 'ui-state-disabled', sPageButtonDisabled: 'ui-state-disabled', sPaging: 'dataTables_paginate fg-buttonset ui-buttonset fg-buttonset-multi ui-buttonset-multi paging_', sSortAsc: H + ' sorting_asc', sSortDesc: H + ' sorting_desc', sSortable: H + ' sorting', sSortableAsc: H + ' sorting_asc_disabled', sSortableDesc: H + ' sorting_desc_disabled', sSortableNone: H + ' sorting_disabled', sSortJUIAsc: ia + 'triangle-1-n', sSortJUIDesc: ia + 'triangle-1-s', sSortJUI: ia + 'carat-2-n-s',
    sSortJUIAscAllowed: ia + 'carat-1-n', sSortJUIDescAllowed: ia + 'carat-1-s', sSortJUIWrapper: 'DataTables_sort_wrapper', sSortIcon: 'DataTables_sort_icon', sScrollHead: 'dataTables_scrollHead ' + H, sScrollFoot: 'dataTables_scrollFoot ' + H, sHeaderTH: H, sFooterTH: H, sJUIHeader: Xb + ' ui-corner-tl ui-corner-tr', sJUIFooter: Xb + ' ui-corner-bl ui-corner-br' });var Mb = _m.ext.pager;h.extend(Mb, { simple: function simple() {
    ...
    }, _numbers: Aa, numbers_length: 7 });h.extend(!0, _m.ext.renderer, { pageButton: { _: function _(a, b, c, d, e, f) {
        var g = a.oClasses,
      ...
      } } });h.extend(_m.ext.type.detect, [function (a, b) {
    var c = b.oLanguage.sDecimal;return Za(a, c) ? 'num' + c : null;
  }, function (a) {
    if (a && !(a instanceof Date) && (!bc.test(a) || !cc.test(a))) return null;var b = Date.parse(a);return null !== b && !isNaN(b) || M(a) ? 'date' : null;
  }, function (a, b) {
  ...
  }]);h.extend(_m.ext.type.search, { html: function html(a) {
    ...
    if (0 !== a && (!a || '-' === a)) return -Infinity;b && (a = Qb(a, b));a.replace && (c && (a = a.replace(c, '')), d && (a = a.replace(d, '')));return 1 * a;
      ...
      return a < b ? 1 : a > b ? -1 : 0;
    } });db('');h.extend(!0, _m.ext.renderer, { header: { _: function _(a, b, c, d) {
    ...
    return 'string' === typeof a ? a.replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/"/g, '&quot;') : a;
  };_m.render = { number: function number(a, b, c, d, e) {
      ...
      return { display: Yb };
    } };h.extend(_m.ext.internal, { _fnExternApiFunc: Nb, _fnBuildAjax: ra, _fnAjaxUpdate: lb, _fnAjaxParameters: ub, _fnAjaxUpdateDraw: vb, _fnAjaxDataSrc: sa, _fnAddColumn: Ga, _fnColumnOptions: ja,
    _fnAdjustColumnSizing: U, _fnVisibleToColumnIndex: Z, _fnColumnIndexToVisible: $, _fnVisbleColumns: aa, _fnGetColumns: la, _fnColumnTypes: Ia, _fnApplyColumnDefs: ib, _fnHungarianMap: Y, _fnCamelToHungarian: K, _fnLanguageCompat: Fa, _fnBrowserDetect: gb, _fnAddData: N, _fnAddTr: ma, _fnNodeToDataIndex: function _fnNodeToDataIndex(a, b) {
    ...
    _fnCallbackFire: u, _fnLengthOverflow: Sa, _fnRenderer: Pa, _fnDataSource: y, _fnRowAttributes: Na, _fnCalculateEnd: function _fnCalculateEnd() {} });h.fn.dataTable = _m;_m.$ = h;h.fn.dataTableSettings = _m.settings;h.fn.dataTableExt = _m.ext;h.fn.DataTable = function (a) {
    return h(this).dataTable(a).api();
  };h.each(_m, function (a, b) {
    h.fn.DataTable[a] = b;
